 ...
 */
package com.amnix.chuck.sample;
...
import com.amnix.chuck.Chuck;
import com.amnix.chuck.ChuckInterceptor;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void doHttpActivity() {
        ...
        RequestBody bitmapBody = RequestBody.create(Base64.encode(byteArrayOutputStream.toByteArray(), Base64.DEFAULT), MediaType.parse("image/jpeg"));
        api.multipart(bitmapBody,
                RequestBody.create("Demo Message", MediaType.parse("text/plain")),
                RequestBody.create("Demo Message", MediaType.parse("text/plain"))).enqueue(cb);
